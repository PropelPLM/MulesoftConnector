...
public abstract class GetServicesApexrestNamespaceApiV3ChangeItemNumberOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH =
      "/services/apexrest/{namespace}/api/v3/change/{itemNumber}";
  ...
  public GetServicesApexrestNamespaceApiV3ChangeItemNumberOperationBase() {
    super();
  }

  public GetServicesApexrestNamespaceApiV3ChangeItemNumberOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getServicesApexrestNamespaceApiV3ChangeItemNumber(
      RestConfiguration config,
      RestConnection connection,
      String namespaceUriParam,
      String itemNumberUriParam,
      boolean affectedItemsQueryParam,
      boolean bomQueryParam,
      boolean amlsQueryParam,
      boolean attachmentsQueryParam,
    ...
    try {
      ...
      getServicesApexrestNamespaceApiV3ChangeItemNumberMain(
          config,
          connection,
          namespaceUriParam,
          itemNumberUriParam,
  ...
  protected void getServicesApexrestNamespaceApiV3ChangeItemNumberMain(
      RestConfiguration config,
      RestConnection connection,
      String namespaceUriParam,
      String itemNumberUriParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addQueryParam("affectedItems", affectedItemsQueryParam)
            .addQueryParam("bom", bomQueryParam)
            .addQueryParam("amls", amlsQueryParam)
            .addQueryParam("attachments", attachmentsQueryParam)
            .addQueryParam("useXMLExportFieldset", useXmlexportFieldsetQueryParam);
    doRequest(
        config,
        connection,
        builder,
