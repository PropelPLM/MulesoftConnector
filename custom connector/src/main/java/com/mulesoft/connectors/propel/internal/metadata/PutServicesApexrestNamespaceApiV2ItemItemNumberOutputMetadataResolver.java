...
public class PutServicesApexrestNamespaceApiV2ItemItemNumberOutputMetadataResolver
  ...
  public String getResolverName() {
    return "put-services-apexrest-namespace-api-v2-item-item-number-output-type-resolver";
  }
