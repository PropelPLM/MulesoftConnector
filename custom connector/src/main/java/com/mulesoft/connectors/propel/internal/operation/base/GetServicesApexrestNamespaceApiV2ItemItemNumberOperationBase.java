...
public abstract class GetServicesApexrestNamespaceApiV2ItemItemNumberOperationBase
  ...
  public GetServicesApexrestNamespaceApiV2ItemItemNumberOperationBase() {
    super();
  }

  public GetServicesApexrestNamespaceApiV2ItemItemNumberOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getServicesApexrestNamespaceApiV2ItemItemNumber(
    ...
    try {
      ...
      getServicesApexrestNamespaceApiV2ItemItemNumberMain(
          config,
          connection,
          namespaceUriParam,
          itemNumberUriParam,
  ...
  protected void getServicesApexrestNamespaceApiV2ItemItemNumberMain(
      RestConfiguration config,
      RestConnection connection,
      String namespaceUriParam,
      String itemNumberUriParam,
